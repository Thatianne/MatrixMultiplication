...
mpirun -np 8 --hostfile hostfile bin/summa_mpi 16 matrix/A_column matrix/B_row output/log.csv 1
echo "Strassen MPI"
...
echo "mpirun -np 1 --hostfile hostfile bin/strassen_mpi_omp 16 matrix/A_row matrix/B_row output/log.csv 1"
mpirun -np 8 --mca orte_base_help_aggregate 0 --hostfile hostfile bin/strassen_mpi_omp 16 matrix/A_row matrix/B_row output/log.csv 1
